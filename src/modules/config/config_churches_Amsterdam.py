...
# how big the allowed color variablility is within the image (can be set to exclude image borders and sensor mistakes) - set to 0 for no threshholding
variability_threshhold=0
